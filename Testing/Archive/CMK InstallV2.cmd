...
REM Main
    ...
    REM Install Cisco Anyconnect
        start "" /wait msiexec.exe /i "C:\Apps\Cisco AnyConnect installer\anyconnect-win-4.8.03052-core-vpn-predeploy-k9.msi" /quiet
    ...
    REM Install Carbon Black
        start "" /wait msiexec /q /i "C:\Apps\Carbon Black Installer\installer_vista_win7_win8-64-3.4.0.1097.msi" /L* cb_install_log.txt COMPANY_CODE=CEA82RE7WWGBKIC5WM@
    REM Restart
        :RSTRT
            shutdown /r /t 0
            exit 
